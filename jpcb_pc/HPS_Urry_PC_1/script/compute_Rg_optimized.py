...
ax.scatter(rg["exp"], rg["pc_double"], c="C2", label="PC double")
ax.plot(rg["exp"], rg["pc_0"], "^", c="C1", label="pc_0")
ax.plot([1, 6], [1, 6], c="k")
