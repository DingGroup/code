...
$PYTHON -u ./script/run_TRE.py --idx_protein $SLURM_ARRAY_TASK_ID --wc 1.0E-3
#$PYTHON -u ./script/run_TRE.py --idx_protein $SLURM_ARRAY_TASK_ID --wc 0.0
