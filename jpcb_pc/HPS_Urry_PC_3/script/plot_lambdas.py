...
# Table
names = params.index.values
print(tabulate({'Amino acid': names, 'HPS-Urry': lambda_init, 'Iteration 1': lambda_pc[0], 'Iteration 2': lambda_pc[1], 'Iteration 3': lambda_pc[2], 'Iteration 4': lambda_pc[3]}, headers='keys', tablefmt='latex', floatfmt=('.2f', '.2f', '.2f', '.2f', '.2f', '.2f')))