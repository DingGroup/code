...
#SBATCH --array=19-21
##SBATCH --nodelist=gollum[054-063]
##SBATCH --nodelist=gollum[064-073]
#SBATCH --nodelist=gollum[074-079,082-085]
#SBATCH --nodes=10
...
PYTHON=/home/xqding/apps/miniconda3/envs/ray/bin/python
